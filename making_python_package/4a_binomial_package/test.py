...
from binomial_package import Gaussian
from binomial_package import Binomial

class TestGaussianClass(unittest.TestCase):
    def setUp(self):
        self.gaussian = Gaussian(25, 2)
        self.gaussian.read_data_file('/home/arslan/github-repositories/DSND_Term2/making_python_package/4a_binomial_package/binomial_package/numbers.txt')
...
class TestBinomialClass(unittest.TestCase):
    def setUp(self):
        ...
        self.binomial.read_data_file('/home/arslan/github-repositories/DSND_Term2/making_python_package/4a_binomial_package/binomial_package/numbers_binomial.txt')
